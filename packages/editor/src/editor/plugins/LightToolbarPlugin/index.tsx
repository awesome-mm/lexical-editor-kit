...
import FontSize, { parseFontSizeForToolbar } from "../ToolbarPlugin/fontSize";
import {
  clearFormatting,
  formatBulletList,
  formatCheckList,
...
const CODE_THEME_OPTIONS_SHIKI: [string, string][] = getCodeThemeOptionsShiki().filter(
  (option) =>
    [
      "catppuccin-latte",
      "everforest-light",
...
export default function LightToolbarPlugin({
  editor,
  activeEditor,
  setActiveEditor,
  setIsLinkEditMode,
